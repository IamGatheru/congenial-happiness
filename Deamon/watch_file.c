...
int main(int argc, char **argv) {
    ...
    if (argc < 2) {
        fprintf(stderr, "USAGE: watch_file PATH\n");
...
//Build persistence and since a deamo should run forever, we must comment out exit statement and introduce a while true loop
